...
export let setupAudio = (): void =>
{
  ...
  shootSound = zzfxG(...[, .1, 500, , .1, , 1, 1.7, -6, .7, , , , , , , .1, .8, , .1]);
  scanSound = zzfxG(...[, , 42, .05, .08, .48, , .57, , -4, -65, .06, .13, , , , , .8, .01, .49]);
  shipDieSound = zzfxG(...[, , 129, .03, .13, .8, 4, 1.51, .1, .8, , , , .1, , .7, , .67, .02, .48]);
  beastDieSound = zzfxG(...[, .1, 500, , .29, .34, 3, 2.43, .8, .4, , , .14, .3, , .3, .29, .79, .08, .25]);
  qDriveSound = zzfxG(...[, 0, 27, .1, 1, .5, 4, 0, -0.5, , -62, .05, .12, , 46, , , .53, .1, .07]);
  hullHitSound = zzfxG(...[, .1, 400, , .05, .35, 4, 1.8, -7, -1, , , , , , .2, , .4]);
};
